...
class PaypalApi {
    ...
    private $_api_live_mode = true;
    private $_api_username = 'admin_api1.wealthskey.com';
    private $_api_password = '2DTF6QE3E5PCE7TY';
    private $_api_signature = 'A0rKbf8Gz8Qq0V5PLImPC.Hn.k6lAXFAbUd.wxs2yxBxBP4APsgMBl59';
    ...
    function __construct($config = array()) {
        if(!empty($config)) {
            if(isset($config['api_live_mode'])) {
                $this->_api_live_mode = $config['api_live_mode'];
            }
    ...
    function setLocationCode($value = 'en_US') {
    ...
    */
    ...
    private function callMarkExpressCheckout(
		...
		$nvpstr.= '&LOCALECODE='.urlencode($this->_location_code);
