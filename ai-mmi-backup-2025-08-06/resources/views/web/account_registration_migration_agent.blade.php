...
<div class="inner-panel">
    ...
    <div class="form">
        <form id="account-agent-form" method="post" enctype="multipart/form-data">
            <div>@csrf</div>
            ...
            <div class="row">
                <label for="company_name"><?php echo $_page_lang['account.company_name']; ?> <span style="color:red;">*</span> <small style="text-transform:none;color:#aaa;"><?php echo $_page_lang['max_company_name']; ?></small></label>
    ...
    <div class="form">
        <form id="account-agent-payment-form" method="post">
            <div>@csrf</div>
            ...
            <div class="action">
                <a class="btn btn-back" href="<?php echo $_page_base_url.'/account_registration/migration_agent' ;?>"><?php echo $_page_lang['btn.back']; ?></a>
