...
<div class="form" style="margin-top:0px;background:#fff;">
    <form id="account-publish-form" method="post" action="<?php echo $_page_base_url.'/posts/renew'; ?> " enctype="multipart/form-data">
        <div>@csrf</div>
        <div><input type="hidden" id="posts_id" name="posts_id" value="<?php echo $_show_posts['id']; ?>"></div>
        <div><input type="hidden" id="member_id" name="member_id" value="<?php echo $_show_posts['member_id']; ?>"></div>

        <div class="title"><?php echo $_page_lang['posts_form.create']; ?></div>
        ...
        <div class="details">
                ...
                <div class="choose">
                    ...
                    <div class="dropdown">
                        <select id="category_type" name="category_type">
                            <option value="1"<?php echo ($_show_posts['category_type']==1)?'selected':''; ?>><?php echo $_page_lang['posts_form.category_type_1']; ?></option>
                            <option value="2"<?php echo ($_show_posts['category_type']==2)?'selected':''; ?>><?php echo $_page_lang['posts_form.category_type_2']; ?></option>
                        </select>
                    </div>
            ...
            <div class="row">
                ...
                <input type="text" class="datepicker" id="created_at" name="created_at" value="<?php echo $_show_posts['created_at']; ?>" placeholder="<?php echo $_page_lang['posts_form.enter_subject']; ?>" data-validation="required">
            </div>
            
            <div class="row">
                <label>Title</label>
                <input type="text" id="title" name="title" value="<?php echo $_show_posts['title']; ?>" placeholder="<?php echo $_page_lang['posts_form.enter_subject']; ?>" data-validation="required">
            </div>

            <div class="row">
                <label>Content</label>
                <textarea id="content" name="content" placeholder="<?php echo $_page_lang['posts_form.enter_content']; ?>" data-validation="required"><?php echo $_show_posts['content']; ?></textarea>
            </div>
            <div class="clearboth"></div>

            <div class="row border">
                <div class="media-title"><?php echo $_page_lang['posts_form.add_to_post']; ?></div>
                <div class="media">
                    <a id="show-publish-photo">
                        <i class="fa fa-picture-o"></i>
                        <span><?php echo $_page_lang['posts_form.photo']; ?></span>
                    </a>
                    <a id="show-publish-video">
                        <i class="fa fa-youtube-play"></i>
                        <span><?php echo $_page_lang['posts_form.video']; ?></span>
                    </a>
                </div>
                ...
                <div class="upload-video">
                    <div>
                        <input type="text" id="youtube_url" name="youtube_url" placeholder="<?php echo $_page_lang['posts_form.youtube_url']; ?>" value="<?php echo $_show_posts['youtube_url']; ?>">
                    </div>
                </div>
                <div class="clearboth"></div>
            </div>
            ...
            <div class="action">
                <button type="submit" class="btn btn-save" style="width:100%;"><?php echo $_page_lang['btn.publish']; ?></button>
                <div class="clearboth"></div>
            </div>
        </div>
